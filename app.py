...
def compute_signals(df):
    ...
    for i in range(2, len(df)):
        ...
        for j in range(1, 3):
            ...
            if None not in (prev_close, curr_close, prev_ma5, prev_ma20, curr_ma5, curr_ma20):
                cond1 = prev_close <= prev_ma5
                cond2 = prev_close <= prev_ma20
                cond3 = curr_close > curr_ma5
                cond4 = curr_close > curr_ma20

                if bool(cond1 or cond2) and bool(cond3 and cond4):
                    ma_ok = True
                    break
